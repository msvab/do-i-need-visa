...
VisaSource.create!([
  {name: "USA Visa Waiver Program (ETSA)", country: "US", url: "http://travel.state.gov/content/visas/english/visit/visa-waiver-program.html", last_modified: nil, etag: "13f184-14ff0-50d6005d30549", updated: false, visa_required: true, on_arrival: false, description: "As you're national of a Visa Waiver Program participant country, you might not need a visa to visit the United States for stays of up to 90 days. However, you must have an authorisation under the Electronic System for Travel Authorization (ESTA) prior to boarding any US-bound ship or aircraft.<br/>You can apply for it <a href=\"http://www.cbp.gov/travel/international-visitors/esta\" title=\"ESTA application site\">here</a>."}
])
